...
T-BAGc is a simple domain-specific language, it has one purpose, to create text-based adventure games. Unlike other languages, T-BAGc has no operotunity for creating classes, functions, or variables, T-BAGc has no need for any of these, it accomplishes it's goal to make a game in without using any of those. This is what makes it unique. T-BAGc makes text-based adventure game creation so much easier and quicker.
